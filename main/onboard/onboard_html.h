...
"}"
"var tgToggle=document.getElementById('telegram_bot');"
"var feishuToggle=document.getElementById('feishu_bot');"
"if(tgToggle){tgToggle.addEventListener('change',updateBotFields);}"
"if(feishuToggle){feishuToggle.addEventListener('change',updateBotFields);}"
"updateBotFields();"
"loadConfig();"
"</script>"
"</body></html>";
